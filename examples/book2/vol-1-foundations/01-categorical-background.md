...
:::section {#h-53a7c9e6a4edcceb title="对象、态射与纤维化"}
:::

我们把一个几何对象的局部数据组织为带纤维的范畴。后续所有多卷引用都从这个基础语言出发。

:::def {#h-2d0964dc07820c6f title="纤维化站点"}
设 $\mathcal{C}$ 是一个带 Grothendieck 拓扑的范畴。若函子 $p:\mathcal{E}\to\mathcal{C}$ 对每个覆盖族都允许笛卡尔提升，则称 $(\mathcal{E},p)$ 为一个**纤维化站点**。
:::

由 @h-2d0964dc07820c6f.title 出发，我们可以给出下降数据的最小闭合条件。

:::lemma {#h-7bf3363aeb9bd429 title="下降核引理"}
...
:::section {#h-3e7e6109986294d4 title="函子性"}
:::

:::prop {#h-c3490c0056062269 title="基变换稳定性"}
若 $f:Y\to X$ 是平坦态射，则 @h-2d0964dc07820c6f 中的下降核在基变换 $f^\ast$ 下保持有限极限。
:::
