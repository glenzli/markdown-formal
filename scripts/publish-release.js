...
function usage() {
    return [
        ...
        '  --github-repo <repo>      gh repo selector. Defaults to glenzli/markdown-formal.',
        '  --gitlab-repo <repo>      glab repo selector. Defaults to glenzli/markdown-formal.',
...
function parseArgs(argv) {
    const options = {
        ...
        githubRemote: 'github',
        gitlabRemote: 'gitlab',
        githubRepo: 'glenzli/markdown-formal',
        gitlabRepo: 'glenzli/markdown-formal',
        draft: false,
        prerelease: false,
    };
