...
The files in `skills/` are not executable installers. They are reviewed source material for a target project's agent instructions.
...
4. Merge any changed `skills/` guidance into project-native instructions.
